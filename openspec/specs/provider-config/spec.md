...
Defines how the LLM provider is configured — API key, base URL, and model selection — with sensible defaults for OpenRouter and backward compatibility with OpenAI.

...
Generates and injects a humorous "curse clause" into the agent's system prompt. The curse forces the model to apply a playful twist or drawback alongside every fulfilled user request, with a unique curse theme picked per session.
